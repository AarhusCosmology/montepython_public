...
output_dir='/path/to/montepython_public/chains/18_shortlived'
MPARGS=" -p /path/to/montepython_public/input/2018_shortlived.param"
MPARGS+=" -o $output_dir"
