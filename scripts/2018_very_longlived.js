#!/bin/bash
#SBATCH --job-name=18_very_longlived
...
output_dir='/path/to/montepython_public/chains/18_very_longlived'
MPARGS=" -p /path/to/montepython_public/input/2018_very_longlived.param"
MPARGS+=" -o $output_dir"
