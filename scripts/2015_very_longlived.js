#!/bin/bash
#SBATCH --job-name=15_very_longlived
...
output_dir='/path/to/montepython_public/chains/15_very_longlived'
MPARGS=" -p /path/to/montepython_public/input/2015_very_longlived.param"
MPARGS+=" -o $output_dir"
MPARGS+=" -c /path/to/montepython_public/covmat/base2015TTTEEE.covmat"
MPARGS+=" -N 5000000000"
