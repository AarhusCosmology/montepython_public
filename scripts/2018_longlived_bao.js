#!/bin/bash
#SBATCH --job-name=18_bao_longlived
...
output_dir='/path/to/montepython_public/chains/18_bao_longlived'
MPARGS=" -p /path/to/montepython_public/input/2018_longlived_bao.param"
MPARGS+=" -o $output_dir"
