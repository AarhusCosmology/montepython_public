#!/bin/bash
#SBATCH --job-name=18_bao_shortlived
...
output_dir='/path/to/montepython_public/chains/18_bao_shortlived'
MPARGS=" -p /path/to/montepython_public/input/2018_shortlived_bao.param"
MPARGS+=" -o $output_dir"
