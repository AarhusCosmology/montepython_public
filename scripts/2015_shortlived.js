...
output_dir='/path/to/montepython_public/chains/15_shortlived'
MPARGS=" -p /path/to/montepython_public/input/2015_shortlived.param"
MPARGS+=" -o $output_dir"
